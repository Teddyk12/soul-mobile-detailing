...
// Re-export booking and availability types and functions for convenience
export type { Booking, AvailabilitySlot as TimeSlot, BookingNote } from './content';
export {
  saveBooking,
  loadBookings as getBookings,
  updateBookingStatus as updateBooking,
  deleteBooking,
  loadAvailability as getAvailability,
  addAvailabilitySlot as addAvailability,
  deleteAvailabilitySlot as deleteAvailability,
  getCustomerHistory,
  addAdminNote,
  getBookingWithHistory,
  enrichBookingWithHistory
} from './content';
